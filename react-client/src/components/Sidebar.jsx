...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed left-0 top-0 z-[60] flex h-screen w-72 flex-col border-r border-border/70 bg-background/95 shadow-sm transition-transform duration-300 md:translate-x-0
